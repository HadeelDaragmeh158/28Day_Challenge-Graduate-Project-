...
$Error = 'Error ... Email Address Is Already Used !';
...
$insert = mysqli_query($dbConn,"insert into users (Full_Name,DOB,Email_Address,Password,Total_Points,Status) values ('$Full_Name','$DOB','$Email_Address','$Password','0','Active')");

$Error = 'Thanks Alot For Signup <a href="Users_Signin.php"> You Can Signin Now !</a>';
  ...
  border-bottom-right-radius: 35px;
		...
		>
            <div class="sidebar-collapse" style="background-color:#EBA7FF"  class="animated" id="animation_box">
                ...
                <li class="nav-header" style="background-image: url('../img/logo.jpg'); background-size: 50% 50%; background-repeat: no-repeat; border-radius: 20px;">
                        <div >
                    ...
                    <li class="">
						...
						<li class="active">
					<a href="Users_Signin.php" title="Technicians Signin"><i class="fa fa-users"></i> <span class="nav-label">Users Signin</span></a>
                    </li>
        ...
        <div class="row" >
            <div class="col-lg-12" style="background-image: url('img/bg11.png'); background-size: 100% 100%; background-repeat: no-repeat;">
...
<div class="col-lg-12">
                <div class="ibox float-e-margins">
                  ...
                  <br>
                     ...
                     <form method="post" action="Users_Singup.php" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">DOB *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" type="date" max="<?php echo date("Y-m-d"); ?>" name="DOB" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>		
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Email Address *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" type="email" name="Email_Address" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Password *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" type="password" name="Password" class="form-control" required  
