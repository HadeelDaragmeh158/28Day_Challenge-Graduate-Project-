...
<div class="col-lg-12">
                <div class="ibox float-e-margins">
                  ...
                  <br>
                     ...
                     <form method="post" action="Users_Signin.php" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <center>	<font style="color:#000">I dont have account? <a href="Users_Singup.php" style="color:#D64BFF">Sign Up</a></font></center>

                            </form>
                 				<br>
		
    <center>	<font style="color:#000"><a href="User_Forget_Password.php" style="color:#D64BFF">Forget your password?</a></font></center>
                 							<br>
