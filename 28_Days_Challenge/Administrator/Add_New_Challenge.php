...
move_uploaded_file($_FILES["file"]["tmp_name"], "Challeneges_Pictures/" . $_FILES["file"]["name"]);
      
      $file=$_FILES["file"]["name"];
	  
	$file = 'Challeneges_Pictures/'.$file;
	

 

$insert = mysqli_query($dbConn,"insert into challenges (Title,Description,Picture) values ('$Title','$Description','$file')");
...
echo "<script language='JavaScript'>
			  alert ('New Challenge Has Been Added Successfully !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Challenge.php" class="form-horizontal" enctype="multipart/form-data">
