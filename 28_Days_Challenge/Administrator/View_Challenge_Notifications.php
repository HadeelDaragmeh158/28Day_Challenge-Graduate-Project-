    ...
    <div id="wrapper">
        ...
        <div class="navbar-header">
         ...
         <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Challenges | <a href="Add_New_Notification.php?C_ID=<?php echo $C_ID; ?>" class="btn btn-primary btn-small">Add New Notification</a></h2>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Challenge Notifications List Information </h5>
					...
					$sql1 = mysqli_query($dbConn,"select * from notifications where C_ID='$C_ID' order by ID DESC");
...
<a href="JavaScript:if(confirm('Are You Sure To Delete This Notificaiton ?')==true)
{window.location='Delete_Notificaiton.php?N_ID=<?php echo $N_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Delete</a>
