            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Challenges List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from challenges order by ID ASC");
                    ...
                    <tr class="grade">
                          ...
                          <td><?php echo $Description; ?></td>
                                        <td><img src="<?php echo $Picture; ?>" width="25%"/></td>
          
                      
                     
 <td><center>
 
   <a href="View_Challenge_Tasks.php?C_ID=<?php echo $C_ID; ?>" class="btn btn-primary btn-sm" role="button">View Challenge Tasks</a>
 <br>
 <a href="View_Challenge_Notifications.php?C_ID=<?php echo $C_ID; ?>" class="btn btn-primary btn-sm" role="button">View Challenge Notifications</a>
 <br>

 <a href="Edit_Challenge.php?C_ID=<?php echo $C_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a>
 <br>
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Challenge ?')==true)
{window.location='Delete_Challenge.php?C_ID=<?php echo $C_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Delete</a>
