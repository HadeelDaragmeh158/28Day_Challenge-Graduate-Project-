            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View User Challenge Tasks Records List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from tasks_records where T_ID='$T_ID' AND U_ID='$U_ID' order by ID ASC");
					while ($row1 = mysqli_fetch_array($sql1)){
						
						$UTR_ID = $row1['ID'];
						$Day_Number = $row1['Day_Number'];
						$Date = $row1['Date'];
						$Notes = $row1['Notes'];
						$Picture_Before = $row1['Picture_Before'];
						$Picture_After = $row1['Picture_After'];
						$Status = $row1['Status'];
						$U_ID = $row1['U_ID'];
                    ...
                    <tr class="grade">
                          ...
                          <td><img src="../Users/<?php echo $Picture_Before; ?>" width="20%"/></td>
                          <td><img src="../Users/<?php echo $Picture_After; ?>" width="20%"/></td>
...
{window.location='Accept_Record.php?Total_Points=<?php echo $Total_Points; ?>&Status=<?php echo $Status; ?>&U_ID=<?php echo $U_ID; ?>&UTR_ID=<?php echo $UTR_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Accept</a>


<br><br>

 <a href="JavaScript:if(confirm('Are You Sure To Delete This Record ?')==true)
{window.location='Delete_Record.php?UTR_ID=<?php echo $UTR_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Delete</a>
