...
$sql1 = mysqli_query($dbConn,"update users set DOB='$DOB', Full_Name='$Full_Name', Email_Address='$Email_Address', Status='$Status' where ID='$U_ID'");
                     ...
                     <form method="post" action="Edit_User.php?U_ID=<?php echo $U_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
							...
							<input type="hidden" name="U_ID" value="<?php echo $U_ID; ?>"/>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Full Name *</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" type="text" name="Full_Name" value="<?php echo $Full_Name; ?>" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">DOB *</label>
                                    ...
                                    <div class="col-sm-10"><input value="<?php echo $DOB; ?>" style="width:450px" type="date" name="DOB" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Email Address *</label>
                                    ...
                                    <div class="col-sm-10"><input value="<?php echo $Email_Address; ?>" style="width:450px" type="email" name="Email_Address" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
