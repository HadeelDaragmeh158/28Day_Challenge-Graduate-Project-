...
$sql1 = mysqli_query($dbConn,"select * from challenges where ID='$C_ID'");
...
$sql1 = mysqli_query($dbConn,"update challenges set Title='$Title', Description='$Description' where ID='$C_ID'");

echo "<script language='JavaScript'>
			  alert ('Challenge Information Has Been Updated !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Edit Challenge Information</h5>
                     ...
                     <form method="post" action="Edit_Challenge.php?C_ID=<?php echo $C_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
							...
							<input type="hidden" name="C_ID" value="<?php echo $C_ID; ?>"/>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Title *</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" type="text" name="Title" value="<?php echo $Title; ?>" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Description *</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" type="text" name="Description" value="<?php echo $Description; ?>" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
