...
$insert = mysqli_query($dbConn,"insert into tasks (C_ID,Day_Number,Description,Total_Points) values ('$C_ID','$Day_Number','$Description','$Total_Points')");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Task.php?C_ID=<?php echo $C_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
                                <input type="hidden" name="C_ID" value="<?php echo $C_ID; ?>"/>
								
								
								 <div class="form-group"><label class="col-sm-2 control-label">Day Number *</label>

                                    <div class="col-sm-10"><input value="" min="1" max="28" style="width:450px" type="number" name="Day_Number" class="form-control" required></div>
                                </div>
                                ...
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Total Points *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:450px" type="number" min="1" name="Total_Points" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
