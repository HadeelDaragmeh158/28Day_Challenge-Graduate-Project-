...
$insert = mysqli_query($dbConn,"insert into notifications (C_ID,Title,Description,Type) values ('$C_ID','$Title','$Description','$Type')");
...
echo "<script language='JavaScript'>
			  alert ('New Notification Has Been Added Successfully !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Notification.php?C_ID=<?php echo $C_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
								...
								<div class="form-group"><label class="col-sm-2 control-label">Type *</label>
                                    ...
                                    <div class="col-sm-10"><select value="" style="width:450px" name="Type" class="form-control" required>
