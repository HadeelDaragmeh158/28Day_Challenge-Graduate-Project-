                            ...
                            <div class="col-lg-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Welcome To 28 Days Challenge | Users Area</h5>
...
<?php
					$sql1 = mysqli_query($dbConn,"select * from challenges order by ID DESC");
				...
				<a href="View_Challenge.php?C_ID=<?php echo $C_ID; ?>" >  <img src="../Administrator/<?php echo $Picture; ?>" width="40%"/></a>
