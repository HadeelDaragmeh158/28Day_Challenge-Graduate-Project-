...
<?php
					...
					$sql12 = mysqli_query($dbConn,"select * from tasks where C_ID='$C_ID'");
					while ($row12 = mysqli_fetch_array($sql12)){
						
				$T_ID=$row12['ID'];
				$Day_Number=$row12['Day_Number'];
				
				if ($Day_Number=='6'){

				echo '<br>';
				
				}elseif ($Day_Number=='11'){

				echo '<br>';

				}elseif ($Day_Number=='21'){
...
$sql3 = mysqli_query($dbConn,"select * from tasks_records where T_ID='$T_ID' AND U_ID='$U_ID'");
if (mysqli_fetch_array($sql3)>0){
...
$BG_Color='black';
				...
				<a href="Send_Record.php?C_ID=<?php echo $C_ID; ?>&T_ID=<?php echo $T_ID; ?>" class="btn btn-primary btn-lg" style="background-color:<?php echo $BG_Color; ?>"> <?php echo $Day_Number; ?></a>
